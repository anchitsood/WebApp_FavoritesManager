...
<table cellpadding="10" cellspacing="0">
    <tr>
        ...
        <td width="130" bgcolor="cyan">
            <img border="0" src="login1.jpg" height="100" width="100">
            </td>
        <td bgcolor="cyan">&nbsp;  </td>
        <td width="500" bgcolor="cyan">
            <p align="center">
				<c:if test="${empty title}">
					<font size="6">Share your Favorites!</font>
				</c:if>
	...
	<!-- Spacer row -->
	<tr>
		<td bgcolor="cyan" style="font-size:5px">&nbsp;</td>
		<td colspan="2" style="font-size:5px">&nbsp;</td>
	</tr>
	
	<tr>
		<td bgcolor="cyan" valign="top" height="500">
			...
			<c:if test="${fn:length(users) != 0}">
				...
				<c:forEach var="users" items="${users}">
					<span class="menu-item">
						<a href="list.do?userName=${users.email}">
